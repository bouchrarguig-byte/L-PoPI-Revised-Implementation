...
import "../src/LPoPIAttestationVerifierYul.sol";

contract LPoPIAttestationVerifierYulTest {
    Groth16Verifier verifier;
    LPoPIAttestationVerifierYul protocol;

    function setUp() public {
        verifier = new Groth16Verifier();
        protocol = new LPoPIAttestationVerifierYul(address(verifier));
    }
