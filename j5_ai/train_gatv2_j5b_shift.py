...
PREP = BASE / "prepared"
OUT = BASE / "results/j5b/gatv2_shift"
...
def build_graph(split):
    ...
    # J5-B controlled attack-family-shift protocol.
    #
    # data_2.csv is excluded from model fitting.
    # The original TEST is NOT evaluated by this training script.
    if split == "train":
        before = len(df)
        df = df[
        ...
        print(
            "J5-B TRAIN exclusion: data_2.csv | "
...
# J5-B challenge is deliberately unopened at this stage.
# No original TEST and no data_2 challenge evaluation here.
test_df = None
test_graph = None
...
print()
print("=== J5-B PRE-CHALLENGE FREEZE ===")
print("data_2 used in training = NO")
...
val_path = OUT / "gatv2_j5b_val_predictions.parquet"
...
freeze = {
    ...
    "seed": SEED,
    "excluded_from_training": "data_2.csv",
    "challenge_opened": False,
    "original_j5_test_used": False,
...
freeze_path = OUT / "j5b_prechallenge_freeze.json"
...
print()
print("J5B_PRECHALLENGE_FREEZE_OK")
